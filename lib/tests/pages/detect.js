...
var detect = require('../../pages/detect');
var htmldocument = require('../../utils/htmldocument');
var path = require('path');
var fs = require('fs');
var detectHTML = fs.readFileSync(path.join(__dirname, '..', 'fixtures', 'detect.html'), 'utf8');
var doc = htmldocument.parse(detectHTML);


test('localisation', function (assert) {
